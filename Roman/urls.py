...
urlpatterns = [
    ...
    path('check_available_slots_ahead/', check_available_slots_ahead, name='check_available_slots_ahead'),
    path('check_available_durations/', check_available_durations, name='check_available_durations'),
